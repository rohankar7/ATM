...
public class Signup extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(!radioBtns[0].isSelected()||!radioBtns[1].isSelected()||!radioBtns[2].isSelected()){
                flag = false;
            }
            ...
            if(ae.getSource() == button){
                if(!flag){
                    ...
                    try{
                        ...
                        String query = "insert into PersonalInfo values('"+name+"','"+gName+"','"+date+"','"+month+"','"+year+"','"+gender+"','"+eMail+"','"+maritalStatus+"','"+address+"','"+city+"','"+pinCode+"','"+state+"')";
