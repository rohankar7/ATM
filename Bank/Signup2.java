...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(int appNo) {
        ...
        setLayout(null);
        labels[11].setBounds(500, 10, 200, 30);
        add(labels[11]);
        textFields[2].setBounds(650, 10, 60, 30);
        add(textFields[2]);
        textFields[2].setEditable(false);
        textFields[2].setText(String.valueOf(appNo));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(ae.getSource() == btn){
                if(religion.equals("")||category.equals("")||income.equals("")||education.equals("")||occupation.equals("")||pan.equals("")||aadhaar.equals("")){
                    JOptionPane.showMessageDialog(null, "Please enter all the details!");
                }
                else{
                    DatabaseConnection conn = new DatabaseConnection();
                    String query = "insert into signup2 values('"+ appNum+ "','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhaar+"','"+seniorAged+"','"+existing+"')";
                    conn.st.executeUpdate(query);
                    new Signup3(appNum).setVisible(true);
                    setVisible(false);
                }
            }
        }
