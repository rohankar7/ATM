...
public class Pin extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            String oldPin = new String(passFields[0].getPassword());
            String newPin = new String(passFields[1].getPassword());
            String conNewPin = new String(passFields[2].getPassword());
